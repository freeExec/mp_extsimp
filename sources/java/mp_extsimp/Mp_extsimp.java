    ...
    */
    ...
    public static void save_MP_2(String filename) {
        ...
        try {
            ...
            bw.write("; Generated by mp_extsimp\n");
            bw.newLine();
            bw.write(MPheader);
...
//*TODO:** label found: lGoNext:;
        //go by chain
        Node nodeK = goByChain(nodeI, nodeJ);
...
//*TODO:** label found: lGoNext2:;
    ...
    //*TODO:** goto found: GoTo lGoNext2;
        ...
        typ = Highway.getType_by_Highway(refEdge.roadtype);
        ...
        if (refEdge.oneway == 2) {
            ...
            for(int i = Chain.size() - 1; i <= 0; i--) {
                ...
                result += String.format("(%1$,%2$)", iChain.lat, iChain.lon);
            }
            //Print #2,;
            result += "\n";
            //Print #2, "Nod1=0,"; CStr(Chain(ChainNum - 1)); ",0";
            //Print #2, "Nod2=" + CStr(ChainNum - 1) + ","; CStr(Chain(0)); ",0";
            result += String.format("Nod1=0,%1$,0\n", Chain.get(Chain.size()-1));
            result += String.format("Nod2=%1$,%2$,0\n", Chain.size()-1, Chain.get(0));
        }
        else {
            ...
            */
            ...
            result += "\n";
            result += String.format("Nod1=0,%1$,0\n", Chain.get(0));
            result += String.format("Nod2=%1$,%2$,0\n", Chain.size()-1, Chain.get(Chain.size()-1));
        }
        //Print #2, "[END]";
        //Print #2, "";
        result += "[END]\n";
